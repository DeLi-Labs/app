...
const faqData = [
  ...
  {
    question: "How is DeLi Labs using artificial intelligence?",
    answer:
      ...
      <div className="mx-auto w-full max-w-[1440px] px-5 lg:px-[75px]">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-end gap-16 lg:gap-[409px]">
          ...
          <button
            ...
            className="cursor-pointer bg-white text-[#070A0D] rounded-[10px] px-[50px] py-[10px] font-medium text-[16px] leading-[120%] tracking-[-0.02em] hover:bg-gray-200 transition-colors flex-shrink-0 mb-2"
          >
